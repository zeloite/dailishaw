  ...
  return (
    <div className="flex min-h-screen bg-[#f7f8fa]">
      ...
      <main className={`flex-1 flex flex-col w-full transition-all duration-300 ${sidebarOpen ? 'lg:ml-[264px]' : 'ml-0'}`}>
        ...
        <div className="flex-1 p-4 lg:p-6 flex flex-col gap-4 lg:gap-6">
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            <Card className="w-full lg:w-[374px] bg-white rounded-[10px] shadow-[0px_2px_4px_#bcbcbc33]">
              <CardContent className="flex flex-col items-center pt-6 lg:pt-11 pb-6">
                <div className="relative w-[100px] h-[100px] lg:w-[135px] lg:h-[140px] mb-6 lg:mb-12">
                  <Image
                    src="/expense-image-14.png"
                    alt="Expense illustration"
                    fill
                    className="object-contain"
                  />
                </div>
                <Button className="w-full max-w-[328px] h-[60px] lg:h-[74px] bg-[#f9831b] hover:bg-[#e67610] rounded-[15px] font-['Inter',Helvetica] font-semibold text-white text-sm lg:text-base px-4">
                ...
                <div className="inline-block min-w-full align-middle">
                  <div className="overflow-hidden">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="font-['Inter',Helvetica] font-medium text-[#1e1e1e] text-sm lg:text-base whitespace-nowrap px-2 lg:px-4">
                            Date
                          </TableHead>
                          <TableHead className="font-['Inter',Helvetica] font-medium text-[#1e1e1e] text-sm lg:text-base whitespace-nowrap px-2 lg:px-4">
                            Doctor&apos;s Met
                      ...
                      <TableBody>
                        {expenseData.map((expense, index) => (
                          <TableRow key={index}>
                            <TableCell className="font-['Inter',Helvetica] font-medium text-[#5d5d5d] text-sm lg:text-base whitespace-nowrap px-2 lg:px-4">
                              {expense.date}
                            </TableCell>
                            <TableCell className="font-['Inter',Helvetica] font-medium text-[#5d5d5d] text-sm lg:text-base px-2 lg:px-4">
                              <div className="flex items-center gap-2 min-w-[140px]">
                                <span className="truncate">{expense.doctor}</span>
                                <div className="relative w-6 h-6 lg:w-7 lg:h-7 flex-shrink-0">
                                  <Image
                                    src="/expense-image-15.png"
                                    alt="Doctor"
                                    fill
