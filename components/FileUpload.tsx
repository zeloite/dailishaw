    ...
    if (variant === 'dropzone') {
      return (
        <div className="w-full">
          ...
          <label
            htmlFor={props.id || 'file-dropzone'}
        ...
        <div className="w-full">
          ...
          <div className="relative">
            <input
              ref={ref}
              type="file"
              className={`w-full rounded-md border border-stroke dark:border-dark-3 p-3 text-body-color dark:text-dark-6 outline-none transition file:mr-4 file:rounded file:border-[.5px] file:border-stroke dark:file:border-dark-3 file:bg-gray-2 dark:file:bg-dark-3 file:py-1 file:px-[10px] file:text-sm file:font-medium file:text-dark dark:file:text-white focus:border-primary file:focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] ${className}`}
              {...props}
            />
          </div>
        </div>
    ...
    return (
      <div className="w-full">
        ...
        <input
          ref={ref}
          type="file"
          className={`w-full cursor-pointer rounded-md border border-stroke dark:border-dark-3 text-dark-6 outline-none transition file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke dark:file:border-dark-3 file:bg-gray-2 dark:file:bg-dark-2 file:py-3 file:px-5 file:text-body-color dark:file:text-dark-6 file:hover:bg-primary file:hover:bg-opacity-10 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 ${className}`}
          {...props}
        />
      </div>
    )
